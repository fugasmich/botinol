...
def table_create():
 ...
 (ID VARCHAR,TEAMS VARCHAR,
 SCORE VARCHAR,TIMER VARCHAR,
 WF_COEF VARCHAR,DRW_COEF VARCHAR,
  WSEC_COEF VARCHAR, WF_DCHANCE_COEF VARCHAR,DRW_DCHANCE_COEF VARCHAR,WSEC_DCHANCE_COEF VARCHAR,HANDICF_LOW VARCHAR,HANDICS_HIGH VARCHAR,T_HIGH VARCHAR, T_LOW VARCHAR)''')
